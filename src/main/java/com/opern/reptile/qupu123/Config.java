...
import com.opern.reptile.BaseConfig;
...
public class Config extends BaseConfig {
    ...
    public static final String OPERN_LIST_TEMP_FILE_NAME = "qupu123OpernListInfo.txt";  //临时文件文件名称
    public static final String OPERN_INFO_TEMP_FILE_NAME = "qupu123OpernInfo.txt";  //临时文件文件名称
